...
vim.keymap.set('n', '<leader><space>', ':b#<cr>', { desc = 'Alternate between buffers'})
vim.keymap.set('n', '<leader>p', function()
  local current_buf_dir = vim.fs.dirname(vim.api.nvim_buf_get_name(0))
  vim.api.nvim_set_current_dir(current_buf_dir)
end)
...
-- disable diagnostic text by default
